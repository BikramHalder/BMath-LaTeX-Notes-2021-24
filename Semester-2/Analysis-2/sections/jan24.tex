...
[Note: $\blacksquare$ marks the end of a proof. If used immediately after a statement to be proved, indicates that the proof is trivial and left as an exercise to the reader]
...
\begin{defn}
  ...
  \item
    We define $\mathcal{P}[a, b]$ to be the set of all partitions (not just those of a fixed cardinality) of $[a, b]$. If the interval is clear from the context, we shall suppress it, writing $\pf[a, b]$ as $\pf$.
