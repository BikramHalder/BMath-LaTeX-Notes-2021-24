...
\newenvironment{cexample}{\begin{exampleBox} \begin{counterexample}}{ \end{counterexample} \end{exampleBox}}
\newenvironment{claim}{\begin{clmBox} \begin{clm}}{ \end{clm} \end{clmBox}}
\newenvironment{props}{\begin{propBox}\begin{propn}}{\end{propn}\end{propBox}}
