...
\begin{example}\label{eg2:jan26}
    ...
    \end{cases} \]
    Then it's trivial to show that $f \notin \mathcal{R}[0,1]$ (the proof is exactly same as the arguments given in \texty{Counter Example} $\ref{ceg1:jan26}$), whereas $|f|$ is simply a constant function, and from \texty{Example} $\ref{eg1:jan26}$, it follows that $|f| \in \mathcal{R}[0,1]$.
\end{example}